...
/**
 * 	\defgroup   factor     Module Factor
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/factor/core/modules directory.
 *  \file       htdocs/factor/core/modules/modFactor.class.php
 *  \ingroup    factor
 *  \brief      Description and activation file for module Factor
 */
include_once DOL_DOCUMENT_ROOT .'/core/modules/DolibarrModules.class.php';


/**
 *  Description and activation class for module Factor
 */
class modFactor extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 104905; // 104000 to 104999 for ATM CONSULTING
		...
		$this->picto='factor.svg@factor';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /factor/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /factor/core/modules/barcode)
		// for specific css file (eg: /factor/css/factor.css.php)
		...
		//							'css' => array('/factor/css/factor.css.php'),	// Set this to relative path of css file if module has its own css file
		//							'js' => array('/factor/js/factor.js'),          // Set this to relative path of js file if module must load a js on all pages
		//							'hooks' => array('hookcontext1','hookcontext2')  	// Set here all hooks context managed by module
		//							'dir' => array('output' => 'othermodulename'),      // To force the default directories names
		//							'workflow' => array('WORKFLOW_MODULE1_YOURACTIONTYPE_MODULE2'=>array('enabled'=>'isModEnabled("module1") && isModEnabled("module2")', 'picto'=>'yourpicto@factor')) // Set here all workflow context managed by module
		//                        );
		$this->module_parts = array(
			'triggers' => 1
		...
		// Example: this->dirs = array("/factor/temp");
		$this->dirs = array();

		// Config pages. Put here list of php page, stored into factor/admin directory, to use to setup module.
		$this->config_page_url = array("factor_setup.php@factor");
		...
		$this->url_last_version = \factor\TechATM::getLastModuleVersionUrl($this);
		...
		// );
		$this->const = array(
			0 => array('FACTOR_PDF_DISPOSITION', 'chaine', 'public_note', '')
		);

		// Array to add new pages in new tabs
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:mylangfile@factor:$user->hasRight('factor', 'read'):/factor/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
		//                              'objecttype:+tabname2:Title2:mylangfile@factor:$user->hasRight('othermodule', 'read'):/factor/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
		...
		/* Example:
		if (! isModEnabled("factor")) $conf->factor->enabled=0;	// This is to avoid warnings
		$this->dictionaries=array(
			'langs'=>'mylangfile@factor',
			...
			'tabcond'=>array(isModEnabled("factor"),isModEnabled("factor"),isModEnabled("factor"))												// Condition to show each dictionary
		);
		*/
		...
		//							'titre'=>'Factor top menu',
		//							'mainmenu'=>'factor',
		//							'leftmenu'=>'factor',
		//							'url'=>'/factor/pagetop.php',
		//							'langs'=>'mylangfile@factor',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		//							'enabled'=>'isModEnabled("factor")',	// Define condition to show or hide menu entry. Use 'isModEnabled("factor")' if entry must be visible if module is enabled.
		//							'perms'=>'1',			                // Use 'perms'=>'$user->hasRight("factor", "level1", "level2")' if you want your menu with a permission rules
		//							'target'=>'',
		...
		$this->menu[$r]=array(	'fk_menu'=>'fk_mainmenu='.$mainMenu,		    // Use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
				...
				'perms'=>'$user->hasRight("facture","lire")',			                // Use 'perms'=>'$user->hasRight("factor", "level1", "level2")' if you want your menu with a permission rules
				'target'=>'',
				'user'=>2);				                // 0=Menu for internal users, 1=external users, 2=both
		$r++;
