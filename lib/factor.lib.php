...
/**
 * Prepare admin tabs for module factor.
 *
 * @return array
 */
...
/**
 * Export invoices list into a specific format.
 *
 * @param DoliDB $db           Database handler
 * @param string $format       Export format
 * @param array  $TRefFacture  Array of invoice refs
 * @return void
 */
function export_factures(&$db, &$format, &$TRefFacture)
{
	switch ($format) {
		case 'natixis':
...
/**
 * Build Natixis export file from invoice refs.
 *
 * @param DoliDB $db          Database handler
 * @param array  $TRefFacture Array of invoice refs
 * @return string|int         Filename on success, 0 on error
 */
